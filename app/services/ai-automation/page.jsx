            ...
            <div className="space-y-6 md:space-y-6 order-1 lg:order-2">
              <div>
                <h2 className="text-[1.8rem] md:text-[2.5rem] lg:text-[2.5rem] 2xl:text-[3.2rem] font-black tracking-tighter leading-[1] text-white">
                  ...
                  <span className=" mt-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">
                    To Scale Revenue
                  </span>
                </h2>
              </div>
      ...
      <section className="relative py-16 2xl:py-40 px-6 overflow-hidden bg-[#111827]">
        ...
        <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-6 border-b border-white/5 pb-10">
            <div>
              <h3 className="text-[1.8rem] md:text-[2.5rem] lg:text-[2.5rem] 2xl:text-[3.2rem] font-black leading-[1.2] tracking-tighter text-white">
                Our{" "}
            ...
            <div className="lg:col-span-6 space-y-6 md:space-y-8">
              ...
              >
                ...
                <div className="space-y-4 max-w-xl 2xl:max-w-3xl">
                  ...
                  {/* 🚀 NEW PARAGRAPH 1: Scalability aur Future-proofing par focus */}
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed mx-auto lg:mx-0 opacity-90">
                    Beyond just fixing immediate inefficiencies, we build with long-term scalability in mind, ensures your digital architecture adapts effortlessly as market demands evolve.
                  </p>

                  {/* 🚀 NEW PARAGRAPH 2: Data-driven clarity aur execution par focus */}
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed mx-auto lg:mx-0 opacity-90">
                    By turning complex data into intuitive, automated actions, we empower your business to make faster, smarter decisions without burning out your internal talent.
                  </p>
