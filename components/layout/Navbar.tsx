        ...
        >
          <Link href="/" className="inline-block outline-none p-0 m-0 leading-[0] group shrink-0 select-none">
            <Image
              ...
              height={40}
              priority
              className="h-5 md:h-7 lg:h-8 w-auto object-contain origin-left"
            />
          </Link>
          ...
          <div className="hidden lg:flex items-center justify-center flex-1 mx-2 xl:mx-6 gap-0.5 xl:gap-2 text-nowrap">
            {links.map((link: any) => {
              ...
              if (link.isDropdown) {
                return (
                  ...
                  >
                    <Link 
                      href={link.href} 
                      className={`flex items-center gap-1 px-2.5 py-1 text-[14px] xl:text-[15px] font-black uppercase tracking-widest transition-all ${isActive || showServices ? "text-white" : "text-white-400 hover:text-zinc"}`}
                    >
              ...
              return (
                <Link key={link.name} href={link.href} className={`relative px-2.5 py-2 text-[14px] xl:text-[15px] font-black uppercase tracking-widest transition-all shrink-0 ${isActive ? "text-white" : "text-white-400 hover:text-zinc"}`}>
                  {link.name}
                </Link>
              );
            })}
