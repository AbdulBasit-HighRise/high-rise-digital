...
export default function PortfolioStylishSlider() {
  ...
  return (
    <section className="relative py-16 md:py-20 2xl:py-32 bg-[#111827] text-white overflow-hidden select-none border-t border-white/5">
      ...
      <div className="absolute top-1/3 left-1/4 w-[600px] 2xl:w-[1000px] h-[600px] bg-blue-600/[0.03] blur-[150px] pointer-events-none" />
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-6">
          ...
          >
            ...
            <p className="mt-2 text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed opacity-80">
              We deliver clear, measurable growth by scaling your brand through high-converting paid social funnels, targeted campaigns, and complete digital marketing strategies.
            </p>
          </motion.div>
